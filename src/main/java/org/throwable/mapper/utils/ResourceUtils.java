...
public final class ResourceUtils {
    ...
    public static Resource[] getResourcesByPathPattern(String pathPattern) {
        ...
        try {
            ...
            resourcesCache.putIfAbsent(pathPattern, resources);
        } catch (IOException e) {
    ...
    public static Resource getResourcesByLocation(String location) {
        ...
        try {
            ...
            resourceCache.putIfAbsent(location, resource);
        } catch (Exception e) {
    ...
    public static String getPropValueByLocation(String location, String key) {
        ...
        if (resource != null) {
            try {
                ...
                log.error(String.format("get resource value from properties file location:[%s] failed,message:%s", location, e));
            }
        }
        return value;
    }
    ...
    public static List<String> getPropValuesByPathPattern(String pathPattern, String key) {
        ...
        for (Resource resource : resources) {
            try {
                ...
                log.error(String.format("get resource values from properties file pathPattern:[%s] failed,message:%s", pathPattern, e));
            }
        }
        return values;
    }
    ...
    public static String getYamlValueByLocation(String location, String key) {
        ...
        if (resource != null) {
            try {
                ...
                log.error(String.format("get resource value from yaml file location:[%s] failed,message:%s", location, e));
            }
        }
        return value;
    }
    ...
    public static List<String> getYamlValuesByPathPattern(String pathPattern, String key) {
        ...
        for (Resource resource : resources) {
            try {
                ...
                log.error(String.format("get resource values from yaml file pathPattern:[%s] failed,message:%s", pathPattern, e));
            }
        }
        return values;
    }
